...
const ResizableHandle = ({
    ...
    // We need to access the direction from the Group context if possible, 
    // but for simplicity in shadcn wrappers, we often rely on data attributes.
    // Since we are seeing issues, we'll try to keep the data attribute logic 
    // but also ensure it's robust.
    return (
        <Separator
            className={cn(
